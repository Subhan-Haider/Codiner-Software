        ...
        <DeepLinkProvider>
          <SidebarProvider>
            ...
            <div
              ...
              className="flex h-[calc(100vh-9rem)] lg:h-[calc(100vh-10rem)] w-full overflow-x-hidden overflow-y-auto mt-24 lg:mt-28 mb-4 lg:mb-10 mx-2 lg:ml-0 lg:mr-2 border border-border/40 rounded-2xl bg-background/60 backdrop-blur-xl transition-all duration-300 ease-in-out shadow-sm"
            >
              {children}
            </div>
            <MadeWithCodiner />
