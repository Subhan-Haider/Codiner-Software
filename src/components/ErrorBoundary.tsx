...
`;
      ...
      const encodedTitle = encodeURIComponent(
        "[bug] Error in Codiner application",
      );
      const githubIssueUrl = `https://github.com/Subhan-Haider/Codiner-Software/issues/new?title=${encodedTitle}&labels=bug,filed-from-app,client-error&body=${encodedBody}`;
      ...
      <div className="max-w-md w-full bg-background p-6 rounded-lg shadow-lg">
        ...
        <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-md flex items-center gap-2">
          ...
          <p className="text-sm text-blue-700 dark:text-blue-400">
            <strong>Tip:</strong> Try closing and re-opening Codiner as a temporary
            workaround.
          </p>
        </div>
      </div>
