...
export class IpcClient {
  ...
  public async restartCodiner(): Promise<void> {
    await this.ipcRenderer.invoke("restart-codiner");
  }
  ...
  public async exportAppAsZip(params: ExportAppAsZipParams): Promise<void> {
    return this.ipcRenderer.invoke("export-app-as-zip", params);
  }
