...
export const CodinerProBudgetSchema = z.object({
  budgetResetAt: z.string(),
  maxBudget: z.number(),
});
export type CodinerProBudget = z.infer<typeof CodinerProBudgetSchema>;
...
export const UserSettingsSchema = z.object({
  ...
  codinerProBudget: CodinerProBudgetSchema.optional(),
