...
<codiner-security-finding title="Unvalidated File Upload Extensions" level="medium">
...
<codiner-security-finding title="Missing CSRF Protection on State-Changing Operations" level="medium">
...
<codiner-security-finding title="SQL Injection in User Lookup" level="critical">
...
<codiner-security-finding title="Hardcoded AWS Credentials in Source Code" level="critical">
...
<codiner-security-finding title="Missing Authentication on Admin Endpoints" level="high">
...
<codiner-security-finding title="JWT Secret Using Default Value" level="high">
...
<codiner-security-finding title="Verbose Error Messages Expose Stack Traces" level="low">
...
<codiner-security-finding title="Missing Security Headers" level="low">
