                        ...
                        <div className="relative p-12 rounded-[4rem] border border-border bg-card/40 backdrop-blur-xl overflow-hidden shadow-3xl">
                            <div className="flex flex-col lg:flex-row gap-16 items-center">
                                <div className="flex-1 space-y-8">
                                    ...
                                    <h2 className="text-4xl md:text-5xl font-black italic tracking-tighter leading-tight group-hover:text-primary transition-colors">
                                ...
                                <div className="flex-1 relative aspect-video w-full rounded-3xl overflow-hidden bg-gradient-to-br from-primary/20 to-blue-600/20 border border-primary/10 group-hover:scale-[1.02] transition-transform duration-700 shadow-2xl">
...
function BlogCard({ date, category, title, desc, icon }: { date: string, category: string, title: string, desc: string, icon: string }) {
    return (
        <motion.div
        ...
        >
            ...
            <div className="space-y-4">
                ...
                <div className="pt-4 flex items-center gap-2 text-primary font-black italic uppercase text-sm tracking-widest opacity-0 group-hover:opacity-100 group-hover:translate-x-2 transition-all">
